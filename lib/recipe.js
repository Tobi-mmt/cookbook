export const recipes = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { quantity: '1 Becher', name: 'saure Sahne' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { quantity: '1 TL', name: 'Salz' },
      { quantity: '1 EL', name: 'Grieß' },
      { quantity: '1 Tasse', name: 'Wasser' }
    ]
  },
  {
    meta: {
  ...
  },
  {
    ...
    ingredients: [
      { section: 'Beize' },
      { quantity: '700 ml', name: 'trockener Rotwein' },
      { quantity: '200 ml', name: 'Rotweinessig' },
      { quantity: '1 Bund', name: 'Suppengrün' },
      ...
      { quantity: '1 Kg', name: 'Rinderschmorbraten' },
      { section: 'Soße' },
      { quantity: '1', name: 'Tomate' },
      { quantity: '50 g', name: 'Rosinen' },
      { quantity: '100 g', name: 'Pumpernickel' },
      { quantity: '1 EL', name: 'Gemüsebrühe (Pulver)' }
    ]
  },
  {
    meta: {
  ...
  },
  {
    ...
    ingredients: [
      { quantity: '250 g', name: 'Butter' },
      { quantity: '200 g', name: 'Zucker' },
      { quantity: '4', name: 'Eier' },
      { quantity: '250 g', name: 'Mehl' },
      { quantity: '150 g', name: 'Schokostreusel' },
      { quantity: '3 Pck.', name: 'Vanille-Zucker' },
      { quantity: '1 EL', name: 'Zimtpulver' },
      { quantity: '1 EL', name: 'Kakaupulver' },
      { quantity: '125 ml', name: 'Rotwein' },
      { quantity: '1 Pck.', name: 'Backpulver' }
    ]
  }
]
